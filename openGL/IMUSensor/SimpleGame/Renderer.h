...
public:
	...
	bool IsInitialized();
	void DrawSolidCube(float x, float y, float z, float eulerX, float eulerY, float eulerZ, float size);
...
private:
	...
	glm::vec3 m_v3CameraPos2D;
	glm::vec3 m_v3CameraUp2D;
	glm::vec3 m_v3CameraLookat2D;
	glm::vec3 m_v3ModelRot2D;
	glm::vec3 m_v3ModelScale2D;
	glm::vec3 m_v3ModelTrans2D;
	glm::mat4 m_m4Model2D;
	glm::mat4 m_m4Rot2D;
	glm::mat4 m_m4ProjView2D;

	glm::vec3 m_v3CameraPos3D;
	glm::vec3 m_v3CameraUp3D;
	glm::vec3 m_v3CameraLookat3D;
	glm::vec3 m_v3ModelRot3D;
	glm::vec3 m_v3ModelScale3D;
	glm::vec3 m_v3ModelTrans3D;
	glm::mat4 m_m4Model3D;
	glm::mat4 m_m4Rot3D;
	glm::mat4 m_m4ProjView3D;
};
